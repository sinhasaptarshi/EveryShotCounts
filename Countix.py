...
class Countix(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        vid, num_frames = read_video_timestamps(video_name, frame_idx, duration=duration-1) ###return frames at passed indices
        vid = self.transform(vid/255.)  
        
        return vid, starts, ends, self.df.iloc[index]['video_id'][:-4]
