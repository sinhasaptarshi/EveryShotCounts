...
class Countix(torch.utils.data.Dataset):
    def __init__(self,
                 ...
                 encode_only=False,
                 sampling_interval=4,
                 data_dir = "/jmain02/home/J2AD001/wwp01/sxs63-wwp01/repetition_counting/CounTR/countix/videos"):
    ...
    def __getitem__(self, index):
        ...
        return vid, exemplar, density, count, starts, ends, self.df.iloc[index]['video_id'][:-4]
...
if __name__=='__main__':
    from tqdm import tqdm
    dat = Countix(split='val', encode_only=True, sampling_interval=1)
