...
python exemplar_counting_train.py --num_gpus 1 --tokens_dir saved_tokens_countix --exemplar_dir exemplar_tokens_countix --save_path ./saved_models_countix_multishot_countnormalized_fullattention --multishot --iterative_shots --dataset Countix --density_peak_width 1.0 --token_pool_ratio 0.6 --encodings mae --full_attention --lr 2e-6
