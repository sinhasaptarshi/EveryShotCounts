...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='video_mae_vit_huge_patch14', type=str, metavar='MODEL',
...
def main(args, cfg=None):
    ...
    dataset_train = Countix(split='train', cfg=cfg)
    print(dataset_train)
    ...
    loss_fun = MultipleMSELoss().to(cur_device)
...
if __name__ == '__main__':
    ...
    args.opts = None
    cfg = load_config(args, 'pretrain_config.yaml')
