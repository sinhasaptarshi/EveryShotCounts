...
python exemplar_counting_train.py --num_gpus 1 --dataset RepCount --tokens_dir saved_swintokens_repcount --exemplar_dir exemplar_swintokens_repcount --save_path saved_models_repcount_swin_attndecoder477_lr5e-5_threshold0.4 --token_pool_ratio 0.9 --multishot --iterative_shots --lr 5e-5 --encodings swin --slurm_job_id $SLURM_JOB_ID --threshold 0.4 --full_attention --window_size 4 7 7
