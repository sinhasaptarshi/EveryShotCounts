...
python exemplar_counting_train.py --num_gpus 1 --dataset RepCount --tokens_dir saved_tokens_reencoded --exemplar_dir exemplar_tokens_reencoded --save_path saved_models_repcountfull_countnormalized_maeencoded_fullattention --token_pool_ratio 0.4 --multishot --iterative_shots --lr 5e-6 --encodings mae --slurm_job_id $SLURM_JOB_ID --full_attention
