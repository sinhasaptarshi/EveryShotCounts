...
python exemplar_counting_train.py --num_gpus 1 --dataset RepCount --tokens_dir saved_tokens_reencoded --exemplar_dir exemplar_tokens_reencoded --save_path saved_models_repcountfull_maeencoded_fullattention_noexemplars_lr1e-5 --token_pool_ratio 0.4 --multishot --iterative_shots --lr 1e-5 --encodings mae --slurm_job_id $SLURM_JOB_ID --threshold 0.0 --full_attention --no_exemplars
